...
#include <../GeographicLib/include/DMS.hpp>
#include <../GeographicLib/include/Utility.hpp>
...
namespace GeographicLib {
  ...
  Math::real DMS::Decode(const std::string& dms, flag& ind) {
    ...
    // ⁰ U+2070   8304  e2_ 81 b0   sup zero
    // ˚ U+02da    730  cb 9a      ring above
    // ∘ U+2218   8728  e2_ 88 98   compose function
    // * U+002a     42  2a         GRiD symbol for degrees

    // MINUTES
    // ' U+0027     39  27         apostrophe
    // ` U+0060     96  60         grave accent
    // ′ U+2032   8242  e2_ 80 b2   prime
    // ‵ U+2035   8245  e2_ 80 b5   back prime
    // ´ U+00b4    180  c2 b4      acute accent
    // ‘ U+2018   8216  e2_ 80 98   left single quote (also ext ASCII 0x91)
    // ’ U+2019   8217  e2_ 80 99   right single quote (also ext ASCII 0x92)
    // ‛ U+201b   8219  e2_ 80 9b   reversed-9 single quote
    ...
    // ″ U+2033   8243  e2_ 80 b3   double prime
    // ‶ U+2036   8246  e2_ 80 b6   reversed double prime
    // ˝ U+02dd    733  cb 9d      double acute accent
    // “ U+201c   8220  e2_ 80 9c   left double quote (also ext ASCII 0x93)
    // ” U+201d   8221  e2_ 80 9d   right double quote (also ext ASCII 0x94)
    // ‟ U+201f   8223  e2_ 80 9f   reversed-9 double quote
    // ʺ U+02ba    698  ca ba      modifier letter double prime

    // PLUS
    // + U+002b     43  2b         plus sign
    // ➕ U+2795  10133  e2_ 9e 95   heavy plus
    //   U+2064   8292  e2_ 81 a4   invisible plus |⁤|

    // MINUS
    // - U+002d     45  2d         hyphen
    // ‐ U+2010   8208  e2_ 80 90   dash
    // ‑ U+2011   8209  e2_ 80 91   non-breaking hyphen
    // – U+2013   8211  e2_ 80 93   en dash (also ext ASCII 0x96)
    // — U+2014   8212  e2_ 80 94   em dash (also ext ASCII 0x97)
    // − U+2212   8722  e2_ 88 92   minus sign
    // ➖ U+2796  10134  e2_ 9e 96   heavy minus

    // IGNORED
    //   U+00a0    160  c2 a0      non-breaking space
    //   U+2007   8199  e2_ 80 87   figure space | |
    //   U+2009   8201  e2_ 80 89   thin space   | |
    //   U+200a   8202  e2_ 80 8a   hair space   | |
    //   U+200b   8203  e2_ 80 8b   invisible space |​|
    //   U+202f   8239  e2_ 80 af   narrow space | |
    //   U+2063   8291  e2_ 81 a3   invisible separator |⁣|

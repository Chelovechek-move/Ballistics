#ifndef PROJECT_BALLISTICS_DIFFERENTIALCORRECTION_HPP
#define PROJECT_BALLISTICS_DIFFERENTIALCORRECTION_HPP
...
#endif //PROJECT_BALLISTICS_DIFFERENTIALCORRECTION_HPP

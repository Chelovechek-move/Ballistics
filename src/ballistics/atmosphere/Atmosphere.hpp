#ifndef PROJECT_BALLISTICS_ATMOSPHERE_HPP
#define PROJECT_BALLISTICS_ATMOSPHERE_HPP
    ...
    public:
        ...
        explicit Atmosphere(const std::string &csvLocation,
                            ...
                            : csvLocation_(csvLocation),
                              ...
                              converter_("../../resources/earth_rotation.csv"),
                              EarthEllipsoid_(a, f)
        { initialize(); }
...
#endif //PROJECT_BALLISTICS_ATMOSPHERE_HPP
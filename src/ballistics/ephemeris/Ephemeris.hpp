...
namespace Ballistics::Ephemeris
{
    ...
    public:
         ...
         */
        Ephemeris(const std::string &fileLocation = "../../resources/ephemeris/de405.bin")
        {
        ...
        */
        template<Time::Scale T>
        [[nodiscard]] vector3d calcVelocities(const Time::Time<T> &jdDate,
                                              const integer target,
                                              const integer center)
                                              const
        {
